...
public final class InstrumentedFilesCollector {
  ...
  public static InstrumentedFilesInfo collect(
      ...
      boolean withBaselineCoverage,
      NestedSet<Pair<String, String>> reportedToActualSources) {
    return collect(ruleContext, spec, localMetadataCollector, rootFiles, coverageSupportFiles, coverageEnvironment, withBaselineCoverage, reportedToActualSources, /* additionalMetadata= */ null);
  }
